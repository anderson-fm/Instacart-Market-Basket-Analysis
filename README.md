...
**False**. As observed, on average, 52.7% of the orders of the day are made during the afternoon (12pm-6pm), while only 41.1% are made in the morning (6am-12pm). <br>
**Hypothesis 02**:

# 3. Machine Learning Model Applied
Both XGBooster and LightGBM models were used in this project.
